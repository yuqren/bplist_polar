...
[N, froz_bits, info_bits, input_IL, sb_IL, IL, IB] = nr_encode_part1(TxRx.E, TxRx.K, TxRx.crc, TxRx.link_mode);
...
[graphs_pos, graphs_inv] = get_permutation_hardware(graphs, TxRx.list_vec(end), N, log2(N));
