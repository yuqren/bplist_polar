...
% Configuration
TxRx.snr        = 0;            % input('select the format: SNR is 0, EbN0 is 1: ');  
...
TxRx.list_vec   = [1 8 32];     % input('input the lists of BPL decoding: '); note that the running time is only decided by the last one
