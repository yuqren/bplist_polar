...
function [dec_bits, dec_iter] = polar_bp_list_float(N, n, llr, H, list_num, graphs_pos, graphs_inv, froz_bits, link, itera, sim_num)
...
for i_frame = 1: sim_num
    for i_graph = 1: list_num
        ...
        u_buf1 = zeros(N, 1); % SA termination (three consecutive identical \hat{u})
        u_buf2 = zeros(N, 1);
        ...
        for i_itera = 1: itera
            ...
            if isequal(u_esti, u_buf1) && isequal(u_buf1, u_buf2)
                break;
            end
